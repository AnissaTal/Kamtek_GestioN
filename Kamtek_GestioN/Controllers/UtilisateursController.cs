...
namespace Kamtek_GestioN.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Telephone,Email,DateEntree")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Telephone,Email,DateEntree")] Utilisateur utilisateur)
        {
